...
/**
 * Transformation that applies a blur effect to images.
 * This implementation uses a stack blur algorithm which is more efficient
 * than a simple box blur and doesn't rely on deprecated RenderScript APIs.
 */
public class BlurTransformation implements Transformation {
    ...
    public Bitmap transform(Bitmap source) {
        ...
        // Apply the blur effect using a stack blur algorithm
        ...
        if (blurRadius > 0) {
            // Use a fast stack blur implementation
            outputBitmap = stackBlur(outputBitmap, blurRadius);
        }
     ...
     * Adapted for Android by Enrique López Mañas
     * Further optimized for PicFly
     */
